...
public class ThereAndBackAgain 
{
	...
	public static void main(String[] args) 
	{
		...
		for(int i=0; i< party1.length; i++) {
			System.out.println(party1[i].getName()+ " has travelled"+ "party1[i].getDistance");
		}
	...
	public static String allTravel(ArrayList<Traveler> party, int miles)
	{
		...
		for( int i =0; i< party.size(); i++) {
			System.out.println(Trav.distanceOfEntire += party.get(i).getName() + " has travelled " +party. get(i).getDistanceTraveled() + " miles");
